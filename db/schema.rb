...
ActiveRecord::Schema.define(version: 20141103184552) do
  ...
  create_table "users", force: true do |t|
    ...
    t.text     "image",           default: "http://www.nycaviation.com/newspage/wp-content/uploads/2013/07/Ranting-Homer2.gif"
  end
